# from scikit-learn import . as sklearn
...
# plot-1 between sepa length and sepal width
for i in range(len(colors)):
  ...
  for i in range(len(colors)):
    ...
    x_train, x_test, y_train, y_test, = train_test_split(x_pca, labels, test_size=0.4, random_state=33)
